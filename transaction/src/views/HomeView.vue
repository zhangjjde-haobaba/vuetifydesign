<template>
  <div class="home">
    <v-toolbar class="mt-5" flat>
      <v-toolbar-title>
        <span class="caption">Overview Dashboard</span><br>Trading view
      </v-toolbar-title>
      <v-app-bar flat color="rgba(0,0,0,0)" class="ml-16">
        <v-tabs color="purple" slider-size="3" v-model="tab">
          <v-tab>
            <v-btn fab color="purple lighten-4" elevation="0" >
<!-- fab 指定按钮为浮动的动作按钮. 按钮将变成圆形按钮.-->
                ...
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle class="white--text">Market Cap $151.450</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
                <v-col cols="12" sm="4">
                  <v-avatar size="100" class="ml-n10 mt-6" tile>
<!--                    tile 删除组件的border-radius样式-->
                ...
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-title class="mb-1 headline white--text">$7220.50</v-list-item-title>
                      <v-list-item-subtitle class="white--text">Market Cap $151.450</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
                <v-col cols="12" sm="4">
                  <v-avatar class="ml-n10 mt-6" tile size="100">
                    <v-img src="wallet.png"></v-img>
                  </v-avatar>
                </v-col>
              </v-row>
              ...
              <v-row>
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
                      <div class="mb-4">
                        <v-btn color="orange lighten-2" fab elevation="0">
                ...
                <v-col cols="12" sm="4">
                  <v-avatar size="100" tile class="ml-n10 mt-6">
                    <v-img src="wallet.png"></v-img>
                  </v-avatar>
                </v-col>
              </v-row>
      ...
      <v-row>
        <v-col cols="12" sm="6">
          <v-card>
            <v-app-bar flat color="rgba(0,0,0,0)">
              <v-toolbar-title class="title black--text pd-0 ml-2">
                Impression
              </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-btn color="deep-purple" class="white--text mt-2">Weekly</v-btn>
              <v-btn color="deep-purple lighten-4" class="deep-purple--text mt-2 ml-2">Monthly</v-btn>
            </v-app-bar>
            <v-sparkline
                    :fill="fill"
                    :line-width="width"
        ...
        <v-col cols="12" sm="6">
          <v-card>
            <v-app-bar flat color="rgba(0,0,0,0)">
              <v-toolbar-title class="title pl-0 ml-2 black--text">
                Activity
              </v-toolbar-title>
            </v-app-bar>
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-toolbar-title class="title ml-2 black--text">
              ...
              <v-col cols="12" sm="4">
                <v-list-item three-line>
                  <v-list-item-content>
                    ...
                    <v-list-item-title class="headline black--text mb-1">2.5578 BTC</v-list-item-title>
                    <v-list-item-subtitle class="grey--text">$2500 USD</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </v-col>
              <v-col cols="12" sm="8">
                ...
                <v-list-item three-line>
                  <v-list-item-content>
                    ...
                    <v-row>
                      ...
                      <v-col cols="12" sm="6">
                        <v-list-item-subtitle class="grey--text mt-8">2.5578 BTC</v-list-item-subtitle>
                        <v-list-item-subtitle class="grey--text">2500 USD</v-list-item-subtitle>
                      </v-col>
                    </v-row>
                  </v-list-item-content>
              ...
              <v-col cols="12" sm="6" align="center">
                <v-list-item two-line class="mt-10">
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle class="grey--text">Pending Balance</v-list-item-subtitle>
                  </v-list-item-content>
